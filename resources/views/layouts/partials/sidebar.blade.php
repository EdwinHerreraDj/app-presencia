<div class="app-sidebar">
    <!-- Sidebar Logo -->
    <div class="logo-box">
        <a href="{{ route('empresas') }}" class="logo-dark">
            <img src="/images/logo-sm.png" style="width: 100px; height: 45px;" class="logo-sm" alt="logo sm">
            <img src="/images/logo-dark.png" style="width: 100px; height: 45px;" alt="logo dark">
        </a>

        <a href="{{ route('empresas') }}" class="logo-light">
            <img src="/images/logo-sm.png" style="margin-left: 15px;" class="logo-sm" alt="logo sm">
            <img src="/images/logo-light.png" style="width: 100px; height: 45px;" alt="logo light">
        </a>
    </div>
...
">
                ...
                <li class="nav-item">
                    <a class="nav-link" href="{{ route('mi.actividad') }}
">
                        <span class="nav-icon">
                            <iconify-icon icon="mingcute:table-line"></iconify-icon>
                        </span>
            ...
            <li class="nav-item">
                ...
                <div class="collapse" id="sidebarError">
                    <ul class="nav sub-navbar-nav">
                        ...
                        <li class="sub-nav-item">
                            <a class="sub-nav-link" href="{{ route('second', ['pages', '404-alt']) }}">Pages 404
                                Alt</a>
                        </li>
                    </ul>
                </div>
            ...
            <li class="nav-item">
                ...
                <div class="collapse" id="sidebarBaseUI">
                    <ul class="nav sub-navbar-nav">
                        ...
                        <li class="sub-nav-item">
                            <a class="sub-nav-link" href="{{ route('second', ['ui', 'list-group']) }}">List
                                Group</a>
                        </li>
                        <li class="sub-nav-item">
            ...
            <li class="nav-item">
                ...
                <div class="collapse" id="sidebarForms">
                    <ul class="nav sub-navbar-nav">
                        ...
                        <li class="sub-nav-item">
                            <a class="sub-nav-link"
                                href="{{ route('second', ['forms', 'flatpicker']) }}">Flatpicker</a>
                        </li>
                        <li class="sub-nav-item">
                            <a class="sub-nav-link"
            ...
            <li class="nav-item">
                ...
                <div class="collapse" id="sidebarLayouts">
                    <ul class="nav sub-navbar-nav">
                        <li class="sub-nav-item">
                            <a class="sub-nav-link" href="{{ route('second', ['layouts-demo', 'dark-sidenav']) }}"
                                target="_blank">Dark
                                Sidenav</a>
                        </li>
                        <li class="sub-nav-item">
                            <a class="sub-nav-link" href="{{ route('second', ['layouts-demo', 'dark-topnav']) }}"
                                target="_blank">Dark
                                Topnav</a>
                        </li>
                        <li class="sub-nav-item">
                            <a class="sub-nav-link" href="{{ route('second', ['layouts-demo', 'small-sidenav']) }}"
                                target="_blank">Small
                                Sidenav</a>
                        </li>
                        <li class="sub-nav-item">
                            <a class="sub-nav-link" href="{{ route('second', ['layouts-demo', 'hidden-sidenav']) }}"
                                target="_blank">Hidden
                                Sidenav</a>
                        </li>
                        <li class="sub-nav-item">
                            <a class="sub-nav-link" target="_blank"
                                href="{{ route('second', ['layouts-demo', 'light']) }}">
