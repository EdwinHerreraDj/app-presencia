        ...
        e &&
            ...
            (e = document.querySelector(".button-toggle-menu")) &&
                e.addEventListener("click", function () {
                    var mensajeWelcome = document.getElementById("welcome-mensaje");
                    if(mensajeWelcome){
                        if(mensajeWelcome.style.display == "none"){
                            mensajeWelcome.style.display = "block";
                        }else{
                            mensajeWelcome.style.display = "none";
                        }
                    }
